%% Find the unique roots of the system of equations for a given range of alph-lambda

clear all; close all
format short
global r kappa a l  ps kappas kappap kappav
%% non dimensional parameters
r=0.05; rhostr = '0_05'; %dipole length rho
...
fdir1 = './files3Td_v6_fine2/Roots3/';
...
lamarr = 0.0:0.01:1.5; Nlam = size(lamarr,2);
alpharr = 0.0:0.005:0.16; Nalph = size(alpharr,2);
